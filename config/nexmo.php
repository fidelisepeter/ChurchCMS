...
return [
    ...
    */
    ...
    'api_key'    => function_exists('env') ? env('NEXMO_KEY', '7432d9a2') : '7432d9a2',
    'api_secret' => function_exists('env') ? env('NEXMO_SECRET', 'g7CzLuLsZemHIX8X') : 'g7CzLuLsZemHIX8X',
    ...
    */
    ...
    'signature_secret' => function_exists('env') ? env('NEXMO_SIGNATURE_SECRET', 'KuPpxWmNaYZOg1XAdgsNcFLzsjtsZE31Nr4DLGUZjFP9gxsA8O') : 'KuPpxWmNaYZOg1XAdgsNcFLzsjtsZE31Nr4DLGUZjFP9gxsA8O',
